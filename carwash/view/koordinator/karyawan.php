...
<head>
  ...
  <title>Thahira Carwash | Koordinator | Karyawan </title>
...
<body class="hold-transition sidebar-mini layout-fixed">
  <div class="wrapper">
      ...
      <section class="content">
        <div class="container-fluid">
          ...
          <div class="card card-info">
            ...
            <!-- /.card-header -->
            <div class="card-body">
              <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" class="row row-cols-lg-auto g-3 align-items-center">
                <input type="hidden" name="pilih" id="pilih" value="001">
                <div class="container">
                  <label for="basic-url" class="form-label">Pilih Periode</label>
                  <div class="input-group mb-3">
                    ...
                    <button type="submit" class="btn form-control btn-info btn-sm"><i class="fas fa-eye"></i></button>
                  </div>
                </div>
              </form>
              <br>
          ...
          <div class="card card-success">
            ...
            <div class="card-body">
              ...
              <table class="table table-striped" name="dua" id="dua">
                <thead>
                  <tr>
                    <th>Nama Lengkap</th>
    ...
    $(document).ready(function() {
      ...
      .appendTo('#dua_wrapper .col-md-6:eq(0)');
    });
