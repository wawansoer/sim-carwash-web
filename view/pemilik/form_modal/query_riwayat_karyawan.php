...
if($uiRiwayat == 0){
  ...
  <strong>Mohon Maaf.</strong> Anda Belum Memilih Karyawan & Periode Transaksi.
  ...
  $result = mysqli_query($koneksi,"SELECT karyawan.nama_panggilan as nama, gaji_karyawan.tanggal as tgl, gaji_karyawan.jumlah as jml,
    ...
    WHERE karyawan.nik = '$nik1'
    AND gaji_karyawan.waktu between '$tgl_pertama1 00:00:01' AND '$tgl_terakhir1 23:59:00'
    ORDER BY gaji_karyawan.waktu desc");


    //ambil nama karyawan
    $ambil_nama = mysqli_query($koneksi, "SELECT nama_panggilan as nama from karyawan where nik = '$nik1'");
    ...
    if(mysqli_num_rows($result) > 0){
      ...
      while($ambil = mysqli_fetch_assoc($result)){
        ...
        from gaji_karyawan left join jenis_trx USING(id_trx) WHERE gaji_karyawan.nik = '$nik1'
