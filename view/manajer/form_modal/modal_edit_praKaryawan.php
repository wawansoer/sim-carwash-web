...
$dataKaryawan = mysqli_query($koneksi, "SELECT * FROM karyawan
  ...
  while ($tabelKaryawan = mysqli_fetch_assoc($dataKaryawan)) {
    ...
    echo "<td>" . $tabelKaryawan['pengalaman'] . "</td>";
    ?>
    <td>
      <!-- Button trigger modal -->
      <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#editPra<?php echo $tabelKaryawan['nik'];?>">
        <i class="fas fa-edit"></i>
      </button>

      <!-- Modal -->
      <div class="modal fade" id="editPra<?php echo $tabelKaryawan['nik'];?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
