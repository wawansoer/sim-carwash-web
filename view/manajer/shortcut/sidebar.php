<div class="preloader flex-column justify-content-center align-items-center">
  <img class="animation__shake" src="../../assets/admin_lte/dist/img/1.png" alt="Thahira Carwash" height="200" width="200">
</div>
<!-- Navbar -->
...
<aside class="main-sidebar sidebar-dark-secondary elevation-4">
  ...
  <a href="" class="brand-link">
    <img src="../../assets/admin_lte/dist/img/1.png" alt="" class="brand-image img-circle elevation-3" style="">
  ...
  <div class="sidebar">
    ...
    <nav class="mt-2">
      <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
        ...
        <li class="nav-item">
          <a href="kategori_kendaraan.php" class="nav-link">
        ...
        <li class="nav-item">
          <a href="bahan_baku.php" class="nav-link">
